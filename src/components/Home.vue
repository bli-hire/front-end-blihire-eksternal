          ...
          <div class="text-center">
            <form class="container-stt">
              ...
              <div class="input-group-btn">
                <a href="alert1.html">
                <button type="button" class="btn btn-info">Tracking</button>
                </a>
              </div>
            </form>
          </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6 col-sm-12">
            <h2>A Career for a Purpose</h2><br>
            <p>Born as the pioneer in Indonesia’s e-commerce, Blibli.com has always believed in the sovereignty of local talents to empower our customers, partners and all generations in Indonesia. For that reason, we invite true creative problem solvers and passionate business builders to empower Indonesia with us. At Blibli.com, through endless opportunities, everyone is invited to solve real world problems and thus making differences every day and in every way for a better life.</p><br>
            <p style="font-style: italic">“Embrace a career for a purpose with us now!”</p>
          </div>
        </div>
      </div>
...
<div id="job" class="container-fluid">
  ...
  <div>
    <div>
      ...
      <div id="tallent" class="collapse container">
    ...
    <div>
      ...
      <div class="list-group">
        ...
        <div id="srsde" class="collapse container-fluid">
        ...
        <a class="list-group-item" v-on:click="" data-toggle="collapse"><router-link to="">Mobile Development Engineer</router-link></a>
        <a class="list-group-item" v-on:click="" data-toggle="collapse"><router-link to="">Technical Support Staff</router-link></a>
        <a class="list-group-item" v-on:click="" data-toggle="collapse"><router-link to="">System Development Engineer Testing</router-link></a>
        <a class="list-group-item" v-on:click="" data-toggle="collapse"><router-link to="">System Development Engineer</router-link></a>
      </div>
    </div>
    <div>
      <h4>Operation</h4>
